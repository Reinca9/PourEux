...
<body>
    ...
    <div id="backgroundColorActuDiv">
        ...
        <article id="deuxiemeArticleActualités">
            ...
            <div id="articleDeuxActuDiv">
                <h1>Agenda</h1>
                <hr>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam dolorem nostrum nihil et expedita.
                    Adipisci accusamus accusantium eum quisquam assumenda?</p>
                <button class="enSavoirPlusActu"><a href=" index.php?page=signIn">En savoir plus</a></button>
            </div>
        </article>
    </div>
